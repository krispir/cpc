...
As mentioned, in the *note* column of the cpc peak table, the outcome of the peak is defined.
...
# (3) Too narrow
table(cpcPeaktable$note[removedPeaksId])

which(cpcPeaktable$note[removedPeaksId] == "not_detected")
which(cpcPeaktable$note[removedPeaksId] == "too_narrow")
